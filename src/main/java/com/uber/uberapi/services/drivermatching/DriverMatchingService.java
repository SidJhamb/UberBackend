...
public class DriverMatchingService {
    ...
    final ConstantsService constants;
    ...
    public DriverMatchingService(MessageQueue messageQueue, ConstantsService constants, LocationTrackingService locationTrackingService, NotificationService notificationService, BookingRepository bookingRepository, ETAService etaService) {
